"""
M00B Lab - Step 3: LangChain Agent
===================================
...
# TODO 1: Decorate this function with @tool.
# LangChain reads the docstring as the schema description.
...
# TODO 2: Create the LLM — ChatOllama(model="mistral") — and the tools list.
llm = None
tools = []

# TODO 3: Build the prompt with ChatPromptTemplate.from_messages([...]):
