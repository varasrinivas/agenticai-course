...
This module contains realistic (but fictional) UCC filing data,
business registry records, and entity variations across multiple states.
"""

# ---------------------------------------------------------------------------
# UCC Filings Database — indexed by state, then filing number
# ---------------------------------------------------------------------------
UCC_FILINGS = {
    "CA": {
        "CA-2023-0847291": {
            "filing_number": "CA-2023-0847291",
            "state": "CA",
            "filing_type": "UCC-1",
        ...
        "CA-2022-0553192": {
            ...
            "amendments": [
                {"amendment_number": "CA-2023-AMD-001", "date": "2023-06-01", "type": "collateral_change", "description": "Added intellectual property as collateral"},
            ],
        },
        "CA-2021-0289451": {
            "filing_number": "CA-2021-0289451",
            "state": "CA",
            "filing_type": "UCC-1",
    ...
    "NV": {
        "NV-2023-0034521": {
            ...
            "debtor_ein": "94-3829471",
            "secured_party": "Nevada Business Finance Corp",
        ...
        "NV-2024-0008871": {
            "filing_number": "NV-2024-0008871",
            "state": "NV",
            "filing_type": "UCC-1",
            "filing_date": "2024-02-28",
            "debtor_name": "Pinnacle Systems Intl",
            "debtor_address": "4400 South Virginia Street, Reno, NV 89502",
            "debtor_ein": "95-7712034",
            "secured_party": "Mountain West Capital Partners",
    ...
    "TX": {
        "TX-2022-1847592": {
            ...
            "status": "active",
            "expiration_date": "2027-11-03",
            "amendments": [
                {"amendment_number": "TX-2023-AMD-001", "date": "2023-09-15", "type": "continuation", "description": "Five-year continuation statement filed"},
            ],
        },
        "TX-2024-0229183": {
            "filing_number": "TX-2024-0229183",
            "state": "TX",
            "filing_type": "UCC-1",
    ...
    "NY": {
        "NY-2023-0558291": {
            ...
            "status": "active",
            "expiration_date": "2028-07-18",
            "amendments": [],
        },
        "NY-2022-0341829": {
            "filing_number": "NY-2022-0341829",
            "state": "NY",
            "filing_type": "UCC-1",
            ...
            "status": "active",
            "expiration_date": "2027-12-05",
            "amendments": [
                {"amendment_number": "NY-2024-AMD-001", "date": "2024-01-15", "type": "secured_party_change", "description": "Assignment of security interest to Chase Capital Markets"},
            ],
        },
    },
    "DE": {
        "DE-2021-0091447": {
            "filing_number": "DE-2021-0091447",
            "state": "DE",
            "filing_type": "UCC-1",
            ...
            "amendments": [
                {"amendment_number": "DE-2023-AMD-001", "date": "2023-03-01", "type": "debtor_name_change", "description": "Debtor name updated from 'Acme Corp' to 'Acme Corporation' per entity name change filed with DE Secretary of State"},
            ],
        },
        "DE-2023-0145592": {
            "filing_number": "DE-2023-0145592",
            "state": "DE",
            "filing_type": "UCC-1",
...
BUSINESS_REGISTRY = {
    ...
    "95-7712034": {
        "ein": "95-7712034",
        "legal_name": "Pinnacle Systems International Inc",
        "dba_names": ["Pinnacle Systems", "PSI Technology", "Pinnacle Systems Intl"],
        "entity_type": "Corporation",
        "state_of_incorporation": "DE",
        "incorporation_date": "2010-08-11",
        "status": "active",
    ...
    "94-5501287": {
        ...
        "registered_agent": "Corporation Service Company, 251 Little Falls Drive, Wilmington, DE 19808",
        "officers": [
            {"name": "Robert Chen", "title": "Managing Member", "since": "2018-07-10"},
        ],
        "addresses": {
    ...
    "51-0482193": {
        "ein": "51-0482193",
        "legal_name": "Trident Logistics Group LLC",
        ...
        "officers": [
            {"name": "James Callahan", "title": "Managing Member", "since": "2017-02-14"},
        ],
        "addresses": {
