...
# Simple UCC filing mock data for this exercise.
# Step 3 uses the full shared mock data; here we keep it self-contained.
MOCK_FILINGS_DB = [
    {
...
def summarize_text(text: str) -> dict:
    ...
    # In production, this might call another LLM or use NLP. Here we do simple keyword detection.
    summary_parts = []
...
def run_agent(user_message: str) -> str:
    ...
    while turn < MAX_TURNS:
        ...
        #   - Log each with observe_tool_call
        #   - Execute using TOOL_FUNCTIONS[block.name](block.input)
        #   - Log with observe_tool_result
        #   - Collect tool_results for the response
        #   - Append the tool name to chain_steps
...
if __name__ == "__main__":
    print("=" * 60)
    print("M06 Lab - Step 2: Sequential Tool Chain")
    print("=" * 60)
