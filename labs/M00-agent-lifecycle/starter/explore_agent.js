 ...
 *     node explore_agent.js "Look up filing UCC-2024-001"
 *     node explore_agent.js                                          // uses default query
 */
...
// Here it is a simple Node.js script — the simplest possible "home."
...
const MAX_AGENT_TURNS = 10; // Prevent infinite loops
const MAX_QUERY_LENGTH = 500; // Reject excessively long inputs
