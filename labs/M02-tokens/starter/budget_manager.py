"""
M02 Lab — Step 3: Context Window Budget Manager
=================================================
...
class ContextBudgetManager:
    ...
    def add_message(self, role: str, content: str) -> dict:
        ...
        # TODO:
        # 1. Count tokens in the content using self._count_tokens()
        # 2. Append {"role": role, "content": content, "tokens": token_count} to self.messages
        # 3. Add the token count to self.total_tokens
        # 4. Return {"tokens": token_count, "total": self.total_tokens, "max": self.max_tokens}
        pass

    def get_usage(self) -> dict:
        """Return current token usage stats."""
        # TODO: Return {"used": self.total_tokens, "max": self.max_tokens,
    ...
    def trim_oldest(self) -> int:
        ...
        # TODO:
        # 1. Count how many messages you remove
        # 2. While self.total_tokens > self.max_tokens and self.messages is not empty:
        #    - Pop the first (oldest) message from self.messages
        #    - Subtract its tokens from self.total_tokens
        #    - Increment removed count
        # 3. Return the count of removed messages
        pass
