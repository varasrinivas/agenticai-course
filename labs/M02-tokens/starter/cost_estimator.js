/**
 * M02 Lab — Step 2: Cost Estimator (Node.js)
 * ============================================
...
function estimateCost(inputTokens, outputTokens, model = "claude-sonnet") {
  // TODO:
  // 1. Look up the model's pricing from the PRICING object
  // 2. Calculate inputCost = (inputTokens / 1_000_000) * pricing.input
  // 3. Calculate outputCost = (outputTokens / 1_000_000) * pricing.output
  // 4. Return { inputCost, outputCost, totalCost: inputCost + outputCost, model }
  return null;
}
