"""
Tests for Capstone 2, Domain A (Healthcare) — Loader and Chunker
...
class TestLoadDocuments:
    ...
    def test_loads_all_five_docs(self):
        """load_documents() should find all 5 policy documents in docs/."""
    ...
    def test_filenames_are_expected(self):
        """The loaded filenames should match the known policy docs."""
        expected_files = sorted([
            "policy_cardiac_cath.md",
            "policy_knee_replacement.md",
            "policy_mri_brain.md",
            "policy_physical_therapy.md",
            "policy_specialty_drugs.md",
        ])
        docs = load_documents(DOCS_DIR)
    ...
    def test_skips_non_markdown_files(self):
        ...
        try:
            # Create one .md and one .txt file
...
class TestChunkDocument:
    ...
    def test_produces_chunks_for_real_doc(self):
        """Chunking a real policy doc should produce at least 1 chunk."""
        docs = load_documents(DOCS_DIR)
