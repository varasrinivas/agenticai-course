/**
 * RAG Agent — Capstone 2, Domain B (Ecommerce) — SOLUTION (Node.js)
 *
...
3. If the context does not contain enough information to answer the question,
   say: "I don't have enough information in the loaded documents to answer that question."
4. When quoting prices, always specify whether they are list prices or contract-specific prices,
   and note any applicable discounts.
...
async function ask(question, context, client, conversationHistory) {
  const userMessage = `Context (retrieved from product catalog and contract documents):\n\n${context}\n\n---\n\nQuestion: ${question}`;
...
async function main() {
  ...
  console.log("\n" + "=".repeat(60));
  console.log("Product Catalog & Contract Q&A Agent");
  console.log("=".repeat(60));
  console.log("Ask questions about products, pricing, and contracts.");
