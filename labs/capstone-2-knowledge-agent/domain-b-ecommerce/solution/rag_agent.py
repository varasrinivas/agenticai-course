"""
RAG Agent — Capstone 2, Domain B (Ecommerce) — SOLUTION

A Retrieval-Augmented Generation agent that answers product catalog
and contract questions using ChromaDB for vector search and Claude
for answer generation with citations.
"""
...
SYSTEM_PROMPT = """\
You are a B2B product catalog and contract reference assistant for Meridian
Industrial Supply. Your job is to answer questions about products, pricing,
customer contracts, and shipping policies using ONLY the provided context.
...
3. If the context does not contain enough information to answer the question,
   say: "I don't have enough information in the loaded documents to answer
   that question."
4. When quoting prices, always specify whether they are list prices or
   contract-specific prices, and note any applicable discounts.
5. Use clear, professional language appropriate for B2B procurement staff.
"""
...
def ask(
    ...
    user_message = (
        f"Context (retrieved from product catalog and contract documents):\n\n"
        f"{context}\n\n---\n\nQuestion: {question}"
    )
...
def main():
    ...
    print("\n" + "=" * 60)
    print("Product Catalog & Contract Q&A Agent")
    print("=" * 60)
    print("Ask questions about products, pricing, and contracts.")
