...
# This JSON Schema tells Claude what the tool does and what arguments it needs.
# =============================================================================
...
# =============================================================================
# YOUR CODE: Implement run_single_tool
# =============================================================================
...
def run_single_tool(user_message: str) -> str:
    ...
    #   (loop through blocks, check hasattr(block, "text"))
    # ------------------------------------------------------------------
    pass

    # ------------------------------------------------------------------
    # TODO 3: Find the tool_use block in response.content
    #   Loop through response.content and find the block where
    #   block.type == "tool_use"
    ...
    #   Call get_weather(tool_input["city"]) and save the result
    #   Log the call with observe_tool_call and observe_tool_result
    # ------------------------------------------------------------------
    pass
...
if __name__ == "__main__":
    print("=" * 60)
    print("M05 Lab - Step 1: Single Tool Call")
    print("=" * 60)
