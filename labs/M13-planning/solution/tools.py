"""
M13 Lab — Research Tools (Complete)
====================================
Same tools from M12: search_filings, get_filing_details, calculate_risk.
These are complete — do not modify. Focus on planner.py instead.
...
if __name__ == "__main__":
    print("=" * 60)
    print("M13 Tools — Self-Test")
    print("=" * 60)

    # Test search_filings
    print("\n--- search_filings(debtor_name='Greenfield') ---")
    result = execute_tool("search_filings", {"debtor_name": "Greenfield"})
    print(result)

    # Test get_filing_details
    print("\n--- get_filing_details(filing_number='UCC-2024-NY-0012847') ---")
    result = execute_tool(
        "get_filing_details", {"filing_number": "UCC-2024-NY-0012847"}
    )
    ...
    # Test calculate_risk
    print("\n--- calculate_risk(debtor_name='Nextera Holdings') ---")
    result = execute_tool("calculate_risk", {"debtor_name": "Nextera Holdings"})
    print(result)
