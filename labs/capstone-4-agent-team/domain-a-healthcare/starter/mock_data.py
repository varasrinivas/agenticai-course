"""
Mock data for Healthcare Pre-Authorization Multi-Agent Pipeline.

This module contains realistic (but fictional) pre-authorization requests,
clinical criteria databases, provider records, and communication templates
used by all 4 agents in the pipeline.

Records include edge cases: experimental procedures, out-of-network providers,
missing documentation, borderline clinical scores, and invalid codes.
"""

# ---------------------------------------------------------------------------
# Pre-Authorization Requests (15+ records with edge cases)
# ---------------------------------------------------------------------------
PREAUTH_REQUESTS = {
    "PA-2024-001": {
    ...
    # --- Edge case: missing diagnosis code ---
    "PA-2024-010": {
    ...
    # --- Edge case: wrong diagnosis for procedure ---
    "PA-2024-011": {
    ...
    # --- Edge case: borderline WOMAC score ---
    "PA-2024-012": {
    ...
    # --- Edge case: unknown provider NPI ---
    "PA-2024-013": {
    ...
    # --- Edge case: high BMI exceeding threshold ---
    "PA-2024-014": {
    ...
    # --- Edge case: seizure with no prior workup (should auto-approve MRI) ---
    "PA-2024-016": {
...
BENEFIT_PLANS = {
    "PLAN-PPO-GOLD": {
        ...
        "covered_categories": [
            ...
            "Diagnostic Imaging", "Pain Management",
        ],
